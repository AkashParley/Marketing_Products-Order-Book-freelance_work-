...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Portal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-line bg-white p-6 shadow-[var(--shadow-card-hover)]",
        className
      )}
      {...props}
    />
