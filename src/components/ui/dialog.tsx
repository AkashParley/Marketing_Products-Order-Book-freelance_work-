  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-h-[88vh] overflow-y-auto rounded-2xl border border-line bg-white p-6 shadow-[var(--shadow-card-hover)]",
    ...
    >
      {children}
      {!hideClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-ink-soft opacity-70 transition-opacity hover:opacity-100 hover:bg-paper-dim">
          <X className="h-4 w-4" />
